...
| `name` | `"sample_pkg_other_launch"` | node name |
| `namespace` | `""` | node namespace |
| `params` | `os.path.join(get_package_share_directory("sample_pkg_other_launch"), "config", "params.yml")` | path to parameter file |
