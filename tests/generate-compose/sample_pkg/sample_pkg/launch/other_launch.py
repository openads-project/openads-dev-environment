...
def generate_launch_description():
    """Generate the launch description for the other_pkg node."""
    ...
    args = [
        DeclareLaunchArgument("name", default_value="other_pkg", description="node name"),
        DeclareLaunchArgument("namespace", default_value="", description="node namespace"),
        DeclareLaunchArgument(
            "params",
            default_value=os.path.join(get_package_share_directory("other_pkg"), "config", "params.yml"),
